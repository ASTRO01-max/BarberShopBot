...
# async def save_user(data, session):
#     user = User(
#         tg_id=data["tg_id"],
...
#     """
#     Telegram ID bo'yicha foydalanuvchini bazadan o'chirish.
#     """
...
# async def update_user(user_id: int, new_fullname: str = None, new_phone: str = None) -> bool:
#     async with async_session() as session:
