...
from .admin_menus import router as admin_menus_router
...
from .admins_shutdown import router as admins_shutdown_router
...
router.include_router(admins_shutdown_router)
